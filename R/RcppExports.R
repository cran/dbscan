...
dbscan_int <- function(data, eps, minPts, weights, borderPoints, type, bucketSize, splitRule, approx) {
    .Call('dbscan_dbscan_int', PACKAGE = 'dbscan', data, eps, minPts, weights, borderPoints, type, bucketSize, splitRule, approx)
}
